namespace Helpdesk.DatabaseInitializer
{
    ...
    public class RBACDatabaseInitializer : CreateDatabaseIfNotExists<RBACDbContext>
    {
        ...
        protected override void Seed(RBACDbContext context)
        {
            ...
            //Create User...
            var user = new ApplicationUser { UserName = "Admin", Email = "khoirul.mustofa2014@gmail.com", Firstname = "System", Lastname = "Administrator", LastModified = DateTime.Now, Inactive = false, EmailConfirmed = true };
